        ...
        <div className="min-h-screen relative flex flex-col items-center justify-center p-4 overflow-hidden">
            ...
            <div className="w-full max-w-md bg-white/10 backdrop-blur-lg rounded-3xl p-8 shadow-2xl border border-white/20 z-10">
                ...
                <form onSubmit={handleSignUp} className="space-y-4">
                    <div>
                        <label className="block text-sm font-bold text-white mb-1 ml-1 drop-shadow-sm">{t('name')}</label>
                        <input
                            type="text"
                            value={name}
                ...
                <p className="mt-6 text-center text-white/90">
                    {t('hasAccount')}{" "}
                    <Link href="/login" className="font-bold text-yellow-400 hover:text-yellow-300 underline underline-offset-4">
                        {t('loginButton')}
                    </Link>
                </p>
